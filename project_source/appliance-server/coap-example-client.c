...
// timer used to simulate a new sensor event
static struct etimer et;
// timer used to start subscription process
...
PROCESS(temperature_process, "Winery sensor device main process");
...
// Process used as startup to subscribe to the server
